...
namespace Aula2
{
    internal class AutomatoFinitoDeterministico
    {
        ...
        public AutomatoFinitoDeterministico()
        {
            ...
            q0.AdicionarTransicao('1', "q0");
            q0.AdicionarTransicao('2', "q1");
            q0.AdicionarTransicao('3', "q0");
            TabelaDeTransicao.Add("q0", q0);

            Estado q1 = new Estado(false);
            q1.AdicionarTransicao('1', "q2");
            q1.AdicionarTransicao('2', "q3");
            q1.AdicionarTransicao('3', "q0");
            TabelaDeTransicao.Add("q1", q1);

            Estado q2 = new Estado(false);
            q2.AdicionarTransicao('1', "q0");
            q2.AdicionarTransicao('2', "q1");
            q2.AdicionarTransicao('3', "q4");
            TabelaDeTransicao.Add("q2", q2);

            Estado q3 = new Estado(false);
            q3.AdicionarTransicao('1', "q2");
            q3.AdicionarTransicao('2', "q3");
            q3.AdicionarTransicao('3', "q4");
            TabelaDeTransicao.Add("q3", q3);

            Estado q4 = new Estado(false);
            q4.AdicionarTransicao('1', "q4");
            q4.AdicionarTransicao('2', "q4");
            q4.AdicionarTransicao('3', "q4");
