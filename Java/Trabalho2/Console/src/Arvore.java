...
public class Arvore {
    ...
    public void ImprimeArvoreCrescente(No raiz, int i) {
    	if(raiz != null) {
            ImprimeArvoreCrescente(raiz.no_esquerda, 2);
            System.out.print(raiz.valor + " ");
            ImprimeArvoreCrescente(raiz.no_direita, 1);
        }
    }
    ...
    public void ImprimeProfundidade(No raiz) {
        if(raiz != null) {
            ...
            System.out.print("No: " + raiz.valor + " profundidade: " + raiz.profundidade + "\n");
